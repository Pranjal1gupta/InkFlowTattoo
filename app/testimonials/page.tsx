        ...
        >
          ...
          <motion.div variants={fadeInVariants}>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed drop-shadow-lg">
              Read what our clients have to say about their experience at Ink Flow Tattoo
            </p>
          </motion.div>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
              Our clients' journeys are our greatest inspiration. Join our community 
              of satisfied collectors and let us help you transform your vision 
              into a permanent masterpiece you'll be proud to share.
            </p>
            <Button size="lg" className="h-14 px-10 text-base group" asChild>
              <Link href="/contact">
                START YOUR JOURNEY
                <motion.span
                  animate={{ x: [0, 5, 0] }}
